...
function App() {
  ...
  const redirectToEmail = () => {
    window.location.href = "mailto:info@glts.am";
  }
      ...
      <div className=" container mx-auto px-[20px]">
        ...
        <div className="text-center h-screen min-h-[500px] md:min-h-[700px] flex flex-col justify-between items-center">
          ...
          <div className='relative'>
            <div className="relative ">
              <div className="z-10 hidden lg:block absolute top-[-200px] floating  floating-4 left-[-500px] w-[700px] h-[700px] bg-[#6CBD4533]  rounded-full blur-[200px]"></div>
              {/* <img className="z-10 absolute top-[-200px] floating  floating-4 left-[-500px] opacity-[0.5] sm:opacity-[1] " src={Ellipse70} alt="" /> */}
              <div className="z-10 hidden lg:block absolute top-[-480px] floating floating-2 right-[-500px] w-[845px] h-[851px] bg-[#6CBD4533] rounded-full blur-[200px]"></div>
              {/* <img className="z-10 absolute top-[-400px] floating floating-2 right-[-350px] opacity-[0.5] sm:opacity-[1] " src={Ellipse68} alt="" /> */}
            ...
            <div className='relative z-[150]'>
              ...
              <div onClick={redirectToEmail} className='w-fit mx-auto cursor-pointer'>
                <JustAppear duration={4} className="z-20 w-[200px] py-[10px] mt-[30px] mx-auto font-bold text-[18px] bg-[#6CBD45] rounded-[30px]">
                  info@glts.am
                </JustAppear>
              </div>
            </div>
